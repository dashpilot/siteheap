...
<div id="dock"><img src="https://app.blogbird.net/assets/editor/img/add.png" id="btn-add" class="exclude grow" /></div>
...
make_editable();
	...
	$('#save').on('click', function(){
		...
		$('#editor').fadeOut('fast', function(){
			...
			$.post("https://builder.pagebricks.com/save", {site: site, page: page, head: head, body: body, main: main}, function( data ) {
